...
public class Cuboid implements Cloneable, ConfigurationSerializable, Iterable<Block> {
	...
	public static String lizenshost = "devcode.net";
	public static String user = "lizens";
	public static String database = user;
	public static String pw = "passwortf�rlizens";
